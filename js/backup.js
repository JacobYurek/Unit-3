(function () {
    var attrArray = [
        ...
        "Number of Residences at extreme Wildfire Risk by State",
    ]; //list of attributes
    ...
    // store maximun value of yscale for each attr
    var attrMax = {
    ...
    function setEnumerationUnits(states, map, path, colorScale) {
        ...
        var mystates = map.append("path").datum(states).attr("class", "mystates").attr("d", path);
    }
